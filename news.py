...
# Query data from the database, open & close the connection
...
# Writing the report and print a title of the report
...
# Print top authors of all the time
...
# Print days in what there were more than 1 percent bad requests
def high_error_days():
